...
function AppReact5() {
  ...
  const [breakAudio, setBreakAudio] = React.useState(sound);
    ...
    <div className="center-align">
      ...
      <div className="dual-container">
        <Length
          title="Break length"
          label="break-label"
          labelDown="break-decrement"
          labelUp="break-increment"
        ...
        <Length
          ...
          labelDown="session-decrement"
          labelUp="session-increment"
          changeTime={changeTime}
          type="session"
          time={sessionTime}
          formatTime={formatTime}
